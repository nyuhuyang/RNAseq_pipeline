...
#---------------------Variables to be set-------------------------#
path=/zenodotus/dat02/elemento_lab_scratch/oelab_scratch_scratch007/yah2014/All_Projects_RNASeq_Data/zhunter #path to all the WM samples in zhunter folder
